...
const uploadIcon = document.querySelector(".bi-camera-video")
const uploadIconFill = document.querySelector(".bi-camera-video-fill")
...
const notificationsIconFill = document.querySelector(".bi-bell-fill")
